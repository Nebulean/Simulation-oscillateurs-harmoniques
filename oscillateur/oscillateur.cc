...
// ============== CONSTRUCTEURS ===============
Oscillateur::Oscillateur(initializer_list<double> const& p, initializer_list<double> const& q, initializer_list<double> const& o, initializer_list<double> const& a, SupportADessin* support = nullptr) // c'est bien la valeur par défaut là ?
